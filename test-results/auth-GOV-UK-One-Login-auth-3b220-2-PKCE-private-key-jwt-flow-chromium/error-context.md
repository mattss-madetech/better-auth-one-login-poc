...
- Name: auth.spec.ts >> GOV.UK One Login auth flow >> sign-in completes the full OAuth2 PKCE + private_key_jwt flow
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://localhost:8080/api/auth/sign-in/social?provider=gov-uk-one-login&callbackURL=/"
